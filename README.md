...
To serve on port 80 with nginx or Caddy, proxy to `http://127.0.0.1:3000`.

## Project layout

- `server.js` – Express server; auth, API routes.
- `auth.js` – Session helpers and `requireAuth` / `requireAdmin` middleware.
- `public/` – Static frontend (HTML, CSS, JS). Served at `/`.
